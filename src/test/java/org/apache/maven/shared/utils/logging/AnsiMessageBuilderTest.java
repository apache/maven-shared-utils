...
public class AnsiMessageBuilderTest {
    ...
    public void shouldColorDebug() {
        ...
        assertEquals("\u001B[1;36mDEBUG\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorInfo() {
        ...
        assertEquals("\u001B[1;34mINFO\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorWarningAndReset() {
        ...
        assertEquals("\u001B[1;33mWARNING\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorError() {
        ...
        assertEquals("\u001B[1;31mERROR\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorSuccessWithMessage() {
        ...
        assertEquals("\u001B[1;32ma success message\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorFailureAndReset() {
        ...
        assertEquals("\u001B[1;31ma failure message\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorStrongAndReset() {
        ...
        assertEquals("\u001B[1ma strong message\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorMojoAndReset() {
        ...
        assertEquals("\u001B[32ma mojo\u001B[m", ansiMessageBuilder.toString());
    }
    ...
    public void shouldColorProjectAndReset() {
        ...
        assertEquals("\u001B[36ma project\u001B[m", ansiMessageBuilder.toString());
    }
}
