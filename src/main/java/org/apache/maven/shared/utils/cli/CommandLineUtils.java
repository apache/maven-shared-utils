...
//                    }
     ...
     * and <code>getSystemEnvVars().get("FILE_PATH")</code> will in general return different values.
     * However, on platforms with case-insensitive environment variables like Windows,
